...
export class Kustomization_v1 extends Renderer.K8sApi.LensExtensionKubeObject<
...
> {
  ...
  static getLastAppliedRevision(object: Kustomization_v1): string | undefined {
    return object.status?.lastAppliedRevision?.replace(/^refs\/(heads|tags)\//, "");
  }

  static getSourceRefText(object: Kustomization_v1): string {
    return [
  ...
  static getSourceRefUrl(object: Kustomization_v1): string | undefined {
...
export class KustomizationApi_v1 extends Renderer.K8sApi.KubeApi<Kustomization_v1> {}
export class KustomizationStore_v1 extends Renderer.K8sApi.KubeObjectStore<Kustomization_v1> {}
