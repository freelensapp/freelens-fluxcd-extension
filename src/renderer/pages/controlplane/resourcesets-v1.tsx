...
const KubeObject = ResourceSet;
type KubeObject = ResourceSet;
type KubeObjectApi = ResourceSetApi;
...
export interface ResourceSetsPageProps {
  extension: Renderer.LensExtension;
}

export const ResourceSetsPage = observer((props: ResourceSetsPageProps) =>
  withErrorPage(props, () => {
      ...
      <>
        ...
        <KubeObjectListLayout<KubeObject, KubeObjectApi>
          ...
          renderTableContents={(object: KubeObject) => [
            ...
            <WithTooltip>{object.status?.lastAppliedRevision || "N/A"}</WithTooltip>,
            <BadgeBoolean
