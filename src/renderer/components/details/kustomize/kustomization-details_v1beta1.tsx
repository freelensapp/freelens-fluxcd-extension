...
import {
  ...
  type KustomizationStore_v1beta1,
} from "../../../k8s/fluxcd/kustomize/kustomization_v1beta1";
...
export const KustomizationDetails_v1beta1: React.FC<Renderer.Component.KubeObjectDetailsProps<Kustomization_v1beta1>> =
  observer((props) => {
    const { object } = props;
    const namespace = object.getNs();
    const store = Kustomization_v1beta1.getStore() as KustomizationStore_v1beta1;
    ...
    const sourceRefUrl = Kustomization_v1beta1.getSourceRefUrl(object);
        ...
        <div className={styles.details}>
          ...
          <DrawerItem name="Source">
            <MaybeLink key="link" to={getMaybeDetailsUrl(sourceRefUrl)} onClick={stopPropagation}>
              {Kustomization_v1beta1.getSourceRefText(object)}
            </MaybeLink>
          </DrawerItem>
